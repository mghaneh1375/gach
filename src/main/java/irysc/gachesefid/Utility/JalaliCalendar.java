...
public class JalaliCalendar extends Calendar {
    ...
    public static class YearMonthDate {
        ...
        public String format(String delimeter) {
            return getYear() + delimeter + (getMonth() + 1) + delimeter + getDate();
        }

        public String eigthDigitFormat(String delimeter) {

            String output = getYear() + delimeter;

            if(getMonth() + 1 < 10)
                output += "0" + (getMonth() + 1) + delimeter;
            else
                output += (getMonth() + 1) + delimeter;
        ...
        public String eigthDigitFormatReverse(String delimeter) {
            ...
            return output + delimeter + getYear();
        }
