...
public class ContentQuizController extends QuizAbstract {
...
//"duration",
    ...
    private final static String[] mandatoryFields = {"title"};

    private final static String[] forbiddenFields = {
            "paperTheme", "database", "startRegistry", "start", "price",
            "end", "launchMode", "showResultsAfterCorrection", "ranking",
            "showResultsAfterCorrectionNotLoginUsers", "capacity",
            "topStudentsGiftCoin", "topStudentsGiftMoney", "topStudentsCount",
            "showResultsAfterCorrectionNotLoginUsers", "permute", "backEn"
    };
    ...
    public static String create(ObjectId userId, JSONObject jsonObject) {
        ...
        try {
            ...
            return irysc.gachesefid.Utility.Utility.generateSuccessMsg(
                    "quiz", new ContentQuizController()
